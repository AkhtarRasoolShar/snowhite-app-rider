...
start_marker = "@OptIn(ExperimentalMaterial3Api::class, androidx.compose.foundation.layout.ExperimentalLayoutApi::class)\n@Composable\nfun OrderChatScreen("
...
if start_marker in content and end_marker in content:
    ...
    new_screen = """@OptIn(ExperimentalMaterial3Api::class, androidx.compose.foundation.layout.ExperimentalLayoutApi::class)
@Composable
fun OrderChatScreen(
    orderId: Int,
    mySenderType: String,
